...
@Fork(1)
public class AverageQuickSortBinaryBench {
    int[][] data;
    int[] curr;
    int index;
    ...
    @Benchmark
    public void measureQuickSortBinary() {
        QuickSortBinary.quickSortBinary(curr);
    }

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(AverageQuickSortBinaryBench.class.getSimpleName())
                .build();
