...
import Laba_2.second.ch2.MSDBinary;
...
@Fork(1)
public class AverageMSDBinaryBench {
    int[][] data;
    int[] curr;
    int index;
    ...
    @Benchmark
    public void measureMSDBinary() {
        MSDBinary.msdSort(curr);
    }

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(AverageMSDBinaryBench.class.getSimpleName())
                .build();
