...
import Laba_2.second.ch2.OrderStatistic;
...
@Fork(1)
public class AverageOrderStatisticBench {
    int[][] data;
    int[] curr;
    int index;
    ...
    @Benchmark
    public void measureOrderStatistic() {
        OrderStatistic.findOrderStatistic(curr, rand.nextInt(curr.length));
    }

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(AverageOrderStatisticBench.class.getSimpleName())
                .build();
