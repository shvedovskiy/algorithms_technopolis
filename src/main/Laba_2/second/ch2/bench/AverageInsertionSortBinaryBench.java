...
@Fork(1)
public class AverageInsertionSortBinaryBench {
    int[][] data;
    int[] curr;
    int index;
    ...
    @Benchmark
    public void measureInsertionSortBinary() {
        InsertionSortBinary.insertionSort(curr);
    }

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(AverageInsertionSortBinaryBench.class.getSimpleName())
                .build();
