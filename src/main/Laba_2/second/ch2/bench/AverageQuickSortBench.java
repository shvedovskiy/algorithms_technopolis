...
import Laba_2.second.ch2.QuickSort;
...
@Fork(1)
public class AverageQuickSortBench {
    int[][] data;
    int[] curr;
    int index;
    ...
    public void setUpTrial() {
        ...
        for (int i = 0; i != 10; ++i) {
            ...
            //data[i] = Helper.genAntiQuickSort(10000);
            //data[i] = Helper.genAntiQuickSort(50000);
            data[i] = Helper.genAntiQuickSort(100000);
        }
    }
    ...
    public void measureQuickSort() {
        QuickSort.quickSort(curr);
    }

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(AverageQuickSortBench.class.getSimpleName())
                .build();
